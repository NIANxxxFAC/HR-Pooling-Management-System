...
function initFindNormalSelectList(){//初始化查询的下拉列表
	...
	function entryOuterInfo(){
		bootbox.confirm({
		    title: "确认提示",
		    message: "是否真的添加此外包员工信息？",
		    buttons: {
		        cancel: {
		    ...
		    callback: function (result) {
		       if(result==true){
		    	   $("#insertOuterEmployeeForm").ajaxSubmit({
		   			url : "outerEmployeeServlet?method=entryOuterEmployeeInfo",
		   			type : "post",
		   			dataType:"json",
		   			success : function(result) {
		   				...
		   				if(result==true){
		   					$("#tipmsg").css("display", "block");
			   				$("#tipmsg").html("添加外包员工信息成功！");
		   				}else
		   					{
		   					$("#tipmsg").css("display", "block");
			   				$("#tipmsg").html("添加外包员工信息失败，请重试！");
		   					}
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h2>外包人员信息录入 | Outsourcing Personnel Information Entry</h2>
          </div>
          <!-- <div class="col-sm-6">
...
<span class="input-group-addon" style="background-color: #0099CC;color:white">
外派公司</span>
<input type="text" id="sendbor" name="sendbor" class="form-control" placeholder="请输入外派公司"> 
<!-- <input type="text" class="form-control" placeholder="请输入身份证号"> -->
</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div class="input-group form-inline col-sm-3 ">
<span class="input-group-addon" style="background-color: #0099CC;color:white">
开始日期</span>
 <input type="date" id="sendbegin" name="sendbegin" class="form-control"> 
...
<span class="input-group-addon" style="background-color: #0099CC;color:white">
补贴</span>
<select id="subsidy" name="subsidy" class="form-control">
<option value="-1">请选择...</option>
...
<span class="input-group-addon" style="background-color: #0099CC;color:white">
外派公司联系人</span>
<input type="text" id="sendcontract" name="sendcontract" class="form-control" placeholder="请输入外派公司联系人"></textarea>
</div>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="input-group-addon" style="background-color: #0099CC;color:white">
外派合同期限</span>
 <input type="text" id="cycle" name="cycle" class="form-control" placeholder="请输入外派合同期限">
<!-- <input type="text" class="form-control" placeholder="请输入身份证号"> -->
</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</div>
</div>
...
<!-- 第三层 -->
<div align="center">
<a href="javascript:void(0)" class="btn btn-success lnr lnr-char-bars" onclick="entryOuterInfo()" style="width: 100px">保存</a>
