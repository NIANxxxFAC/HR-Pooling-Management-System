...
function findNormalSalary(){
	$('#table').bootstrapTable({
		url : "normalEmployeeServlet?method=findNormalSalaryInfo",
		striped : true,
		pagination : true,
		clickToSelect : true,
	    ...
	    callback: function (result) {
	       if(result==true){
	    	   $("#updateNormalSalaryForm").ajaxSubmit({
	   			url : "normalEmployeeServlet?method=updateNormalSalary",
	   			type : "post",
	   			dataType:"json",
	   			success : function(result) {
	   				if(result==true){
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10">
            <h2>普通员工薪资管理 | Ordinary Employees Salary Management </h2>
          </div>
          <!-- <div class="col-sm-6">
