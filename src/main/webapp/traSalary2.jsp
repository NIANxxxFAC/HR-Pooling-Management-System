...
function findStudentSalary(){
	$('#table').bootstrapTable({
		url : "studentEmployeeServlet?method=findStudentSalaryInfo",
		striped : true,
		pagination : true,
		clickToSelect : true,
...
function updateSalaryNormalInfo(){
	bootbox.confirm({
	    title: "确认提示",
	    message: "是否真的修改所选实习生薪资？",
	    buttons: {
	        cancel: {
	    ...
	    callback: function (result) {
	       if(result==true){
	    	   $("#updateNormalSalaryForm").ajaxSubmit({
	   			url : "studentEmployeeServlet?method=updateStudentSalary",
	   			type : "post",
	   			dataType:"json",
	   			success : function(result) {
	   				if(result==true){
	   					$('#table').bootstrapTable("refresh");
	   					$("#tipmsg").css("display", "block");
		   				$("#tipmsg").html("修改实习生薪资成功！");
	   				}else
	   					{
	   					$("#tipmsg").css("display", "block");
		   				$("#tipmsg").html("修改实习生薪资失败，请重试！");
	   					}
    ...
    <!-- Content Header (Page header) -->
     <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-8">
            <h2>实习生薪资管理 | Trainee Salary Management </h2>
          </div>
          <!-- <div class="col-sm-6">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
             ...
             <div class="modal-body" align="center">
              ...
              <form id="updateNormalSalaryForm" action="#" method="post" class="form-horizontal">
		...
		<input type="text" id="normal_pafhc" name="normal_pafhc" class="form-control"/></div>				
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="updateSalaryNormalInfo()">提交更改</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
